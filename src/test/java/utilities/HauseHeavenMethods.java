...
public class HauseHeavenMethods {
    ...
    public static void windowsHanldes( int sayi){
        ...
        Assertions.assertEquals(Driver.getDriver().getWindowHandles().size(), sayi);
    }
    ...
    public static  void adminLogoutTesti (){
        ...
        Assertions.assertTrue(adminDashboard.sefadminLogoutConfirmMsgelementi.isDisplayed());
