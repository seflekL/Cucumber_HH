...
public class UserDashboard {
    ...
    public WebElement listingSonucsayisi;
    @FindBy(xpath = "//*[@class='btn btn btn-theme-light-2 rounded full-width mt-3']")
    public WebElement lisingsayfasiFindNewHomeButtonu;
    @FindBy(xpath = "//*[@class='footer-first']")
    public List<WebElement> listingLoctionsList;
    @FindBy(xpath = "//*[@class='listing-card-info-price']")
    public List<WebElement> listingsayfasiFiyatList;

    @FindBy(xpath = "//*[@class='inc-fleat-icon']")
    public List<WebElement> listingIconsList;
    ...
    public List<WebElement> listingIMGList;
